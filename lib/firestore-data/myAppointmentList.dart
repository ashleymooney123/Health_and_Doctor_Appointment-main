...
class _MyAppointmentListState extends State<MyAppointmentList> {
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = TextButton(
      child: Text(LocaleKeys.yesText.tr()),
      onPressed: () {
    ...
    AlertDialog alert = AlertDialog(
      title: Text(LocaleKeys.confirmDeleteText.tr()),
      ...
      child: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return snapshot.data.size == 0
              ? Center(
                  child: Text(
                    LocaleKeys.noAppointmentScheduled.tr(),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        LocaleKeys.patientName.tr() + document['name'],
                                        style: GoogleFonts.lato(
                                          fontSize: 16,
                                        ),
                                      ),
                                  ...
                                  IconButton(
                                    tooltip: LocaleKeys.deleteAppointmentText.tr(),
                                    icon: Icon(
                                      Icons.delete,

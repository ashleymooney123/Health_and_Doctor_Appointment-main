        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFormField(
              ...
              validator: (value) {
                if (value.isEmpty) {
                  return  LocaleKeys.emailEnterText.tr();
                } else if (!emailValidate(value)) {
                  return LocaleKeys.emailIncorrectText.tr();
                } else {
                  return null;
                }
              },
            ...
            TextFormField(
              ...
              validator: (value) {
                if (value.isEmpty) return LocaleKeys.passwordEnterText.tr();
                return null;
              },
              obscureText: true,
            ),
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {},
                child: Text(
                  LocaleKeys.forgotPasswordButton.tr(),
                  style: GoogleFonts.lato(
                    fontSize: 16,
      ...
      final snackBar = SnackBar(
        content: Row(
          children: [
            ...
            Text(LocaleKeys.signinErrorText.tr()),
          ],
        ),
      );
